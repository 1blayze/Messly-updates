...
export const BANNER_MIN_H = 240;
export const BANNER_MAX_W = 3000;
export const BANNER_MAX_H = 1200;

export const AVATAR_ALLOWED_TYPES = ["image/png", "image/jpeg", "image/webp", "image/gif"] as const;
export const BANNER_ALLOWED_TYPES = ["image/png", "image/jpeg", "image/webp", "image/gif"] as const;
