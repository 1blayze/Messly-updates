...
function AuthBootstrapSplash() {
  return (
    <div className="startup-auth-surface" data-messly-startup-surface="shell">
      <AppStartupScreen statusText="Carregando Azyoon" detailText="Preparando aplicativo" progress={0.1} phase="running" />
    </div>
  );
}
...
function AppShellRoute() {
  ...
  return (
    <Suspense
      fallback={(
        <AppStartupScreen statusText="Carregando Azyoon" detailText="Abrindo interface" progress={0.98} phase="ready" />
      )}
    >
      <AppShell />
    </Suspense>
